...
export default function Home() {
  ...
  return (
    <div className="page">
      <video ref={videoRef} src="../../videos/doorclosed.webm" type="video/webm" autoPlay />
      <div className={`choixUsager ${showChoices ? "visible" : ""}`}> 
        <Link className="choix" href="../reveil/closed/cries">
          <span>pleure à la porte</span>
        </Link>

        <Link className="choix" href="../reveil/closed/pushes">
